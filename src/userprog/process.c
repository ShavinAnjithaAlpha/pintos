...
start_process (void *pcb_)
{
  ...
  if (success)
    push_args_to_stack (args, count, &if_.esp);
...
process_exit (void)
{
  ...
  while (!list_empty (files))
    {
      f_desc = list_entry (list_pop_front (files), struct file_desc, elem);
...
static void
push_args_to_stack (char **args, int argc, void **esp)
{
