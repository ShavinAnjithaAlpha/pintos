...
char PROMPT[] = "pintos: ";
char USERNAME[] =  "190349K - Nethum Lamahewage";
...
/* Read a line of text from input buffer */
char *
read_line (void) {
      ...
      if (position >= buf_size)
        {
          ...
          char *temp = realloc (buffer, sizeof *temp * buf_size);
          if (temp == NULL)
            {
              printf ("\nMemory allocation error\n");
              return NULL;
...
/* Run the shell command
   Return 1 if shell should terminate,
   otherwise return 0 */
int
